...
mod tests {
    ...
    fn test_performance_metrics_calculation() {
        let equity_curve = vec![
            ...
            EquityPoint { timestamp: 1, equity: 10500.0, drawdown: 0.0 },
            EquityPoint { timestamp: 2, equity: 11000.0, drawdown: 0.0 },
        ];
        ...
        let metrics = PortfolioAnalytics::calculate_metrics(
            10000.0,
            11000.0,
            &equity_curve,
            &trades,
