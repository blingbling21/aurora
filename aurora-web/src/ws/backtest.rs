...
use crate::state::{AppState, BacktestStatus};
        ...
        tokio::select! {
            _ = interval.tick() => {
                ...
                if let Some(task) = tasks.get(&task_id) {
                    ...
                    if matches!(task.status, BacktestStatus::Completed | BacktestStatus::Failed) {
